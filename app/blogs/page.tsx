            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="lg:col-span-2">
                  {/* Blog Preview */}
                   <Link href={`/blogs/${blogPosts[0].slug || 'presenting-ieee-cs-sliit-web-dev-team'}`}>
                     <div 
                       className="relative overflow-hidden mb-6 cursor-pointer group"
                       style={{ 
                     ...
                     >
                      <img 
                        src={blogPosts[0].image || "/myblog1.webp"} 
                        ...
                        style={{ 
                          ...
                          height: '452.908px',
                          borderRadius: '12px',
                          boxShadow: '0 40px 80px -15px rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(255, 255, 255, 0.1)',
                          display: 'block',
                      ...
                      />
                       ...
                       {/* Shadow Effect Filter Layer */}
                       <div 
                         className="absolute inset-0 pointer-events-none"
                         style={{
                           background: 'linear-gradient(to bottom, transparent 0%, rgba(0, 0, 0, 0.1) 50%, rgba(0, 0, 0, 0.7) 100%)',
                           borderRadius: '12px',
                           filter: 'drop-shadow(0 60px 120px rgba(0, 0, 0, 1))'
                         }}
                       ></div>
                       
                       {/* Additional Bottom Shadow Layer */}
                       <div 
                       ...
                       {/* Text overlay on bottom left of image */}
                       <div className="absolute bottom-4 left-4 z-10">
                         <div className="flex items-center gap-2 mb-2">
                           <Clock className="w-4 h-4 !text-white" />
                           <span className="!text-white" style={{ fontSize: '14.4px' }}>{blogPosts[0].date}</span>
                         </div>
                         <h3 className="font-bold !text-white" style={{ fontSize: '18.4px' }}>{blogPosts[0].title}</h3>
                       </div>
                     </div>
                   </Link>
                </div>
                ...
                {blogPosts.slice(1).map((post) => {
                  const CardContent = (
                    <>
                      {/* Content Preview */}
                      <div 
                        className={`relative overflow-hidden mb-6 ${post.slug ? 'cursor-pointer' : ''} group`}
                        style={{ 
                      ...
                      >
                      {post.content.type === "logos" && (
                        <img 
                          src="/blog2.png" 
                          alt="Google and Facebook Logos" 
                          className="will-change-transform"
                          style={{ 
                            width: '354.33px',
                            height: '265.743px',
                      ...
                      {post.content.type === "website" && (
                        <img 
                          src="/blog3.png" 
                          alt="Zyphora Crypto Website" 
                          className="will-change-transform"
                          style={{ 
                            width: '354.33px',
                            height: '265.743px',
                      ...
                      <div 
                        className="absolute inset-0 pointer-events-none"
                        style={{
                          background: 'linear-gradient(to bottom, transparent 0%, rgba(0, 0, 0, 0.1) 50%, rgba(0, 0, 0, 0.6) 100%)',
                          borderRadius: '12px',
                      ...
                      <div className="absolute bottom-4 left-4 z-10">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="!text-white" style={{ fontSize: '14.4px' }}>{post.date}</span>
                        </div>
                        <h3 className="font-bold !text-white" style={{ fontSize: '18.4px' }}>{post.title}</h3>
                      </div>
                    </div>
                    </>
                  );
              ...
              <div className="space-y-4">
                {recentPosts.map((post) => (
                  <Link 
                    ...
                    className="flex gap-4 py-3 px-1 hover:bg-gray-200 dark:hover:bg-[#313131] cursor-pointer group"
                    style={{
                      width: '337.763px',
                      height: '119.991px',
                      borderRadius: '0px',
        ...
        <div className="lg:hidden space-y-4">
          ...
          <div className="rounded-none p-6 border-x-0 border-t border-b border-gray-300 dark:border-white/10 shadow-lg bg-white dark:bg-[#212121]">
                ...
                <div className="relative overflow-hidden rounded-xl cursor-pointer group">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-gray-300 text-xs">{blogPosts[0].date}</span>
                    </div>
                    <h3 className="font-bold text-white text-base leading-tight">{blogPosts[0].title}</h3>
                  </div>
                </div>
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {blogPosts.slice(1).map((post) => {
                const getImageSrc = () => {
                  if (post.content.type === "event") {
                    return post.image;
                  } else if (post.content.type === "project") {
                    return post.image;
                  } else if (post.id === 2) {
                    return "/blog2.png";
                  } else {
                  ...
                  <div className="relative overflow-hidden rounded-xl cursor-pointer group">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/80 to-transparent">
                      <div className="flex items-center gap-1 mb-1">
                        ...
                        <span className="text-gray-300 text-[10px]">{post.date}</span>
                      </div>
                      <h3 className="font-bold text-white text-xs leading-tight line-clamp-2">{post.title}</h3>
                    </div>
                  </div>
                );
