...
import { Clock, ArrowLeft, Facebook, Mail, Github, Linkedin, MessageCircle, Home, User, Trophy, FolderOpen, BookOpen } from "lucide-react"
...
const blogData = {
  "presenting-ieee-cs-sliit-web-dev-team": {
    ...
    images: [
      "/myblog1.webp", // Main image with team members (5 members in yellow circles)
      "/myblog12.webp"  // Secondary image (team lead + 4 members)
    ],
    content: {
  ...
  "google-io-extended-sri-lanka": {
    ...
    images: [
      "/googlio.webp"  // Event collage showcasing the amazing Google I/O Extended experience
    ],
    content: {
      introduction: "🎉 Had an amazing time at Google I/O Extended Sri Lanka hosted by GDG! Grateful for the insights, and the incredible community. Proud to be part of it! 💡🌍",
      
      description: "Attending Google I/O Extended Sri Lanka was an incredible opportunity to connect with the tech community, learn from Google's latest innovations, and network with like-minded developers. The event brought together developers, designers, and tech enthusiasts to explore the future of technology and its impact on our world. Being part of such an inspiring community motivates me to continue pushing boundaries in tech.",
      
      hashtags: ["GoogleIO", "GDGSriLanka", "TechForFuture", "IOExtendedSL", "TechCommunity", "Google", "Innovation"]
    }
  },
  "spymic-project-attention": {
    ...
    content: {
      introduction: "🔥 My spymic project got attention from GiamMa-based researchers SDR R&D IoT!",
      
      description: "I'm excited to share that my Spy Mic project has caught the attention of GiamMa-based researchers specializing in Software Defined Radio (SDR) R&D and IoT technologies. This innovative project allows users to turn their Bluetooth earbuds or AirPods into spy microphones by connecting them to their smartphone and utilizing reverse hearing technology.",
      
      project: {
        name: "Spy Mic",
        link: "https://lnkd.in/g28BjqNW",
        github: "https://github.com/VehanRajintha/BT-Reverse-hearing-website-spy-mic-",
        technologies: ["JavaScript", "Web Audio API", "Bluetooth"],
        description: "A web-based application that transforms your Bluetooth earbuds into long-range microphones for innovative audio monitoring applications."
      },
      
      hashtags: ["trendingpost", "Research", "IoT", "project", "newideas", "spymic", "SoftwareDefinedRadio", "SDR", "Bluetooth"]
    }
  },
...
export default function BlogDetailPage({ params }: { params: Promise<{ slug: string }> | { slug: string } }) {
  ...
  const slug = 'then' in params ? currentSlug : params.slug
          ...
          <div className="overflow-y-auto md:ml-68">
            <div className="flex gap-6">
              ...
              <div className="bg-white dark:bg-[#212121] rounded-2xl p-8 border border-gray-300 dark:border-white/6 shadow-lg">
                {/* Back Button */}
                <Link href="/blogs" className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-all duration-700 mb-6">
              ...
              <div className="bg-white dark:bg-[#212121] rounded-2xl p-8 border border-gray-300 dark:border-white/6 shadow-lg">
                <div className="space-y-6">
                  {blog.images.map((image, index) => (
                    <div key={index} className="relative overflow-hidden rounded-xl bg-white dark:bg-transparent">
                      <img 
                        src={image} 
                        alt={`${blog.title} - Image ${index + 1}`}
                        className="w-full h-auto rounded-xl will-change-transform"
                        style={{
              ...
              <div className="bg-white dark:bg-[#212121] rounded-2xl p-8 border border-gray-300 dark:border-white/6 shadow-lg">
                <div className="prose prose-lg dark:prose-invert max-w-none">
                  <p className="text-xl leading-relaxed mb-6 !text-black dark:!text-white">
                    {blog.content.introduction}
                  </p>

                  {blog.content.team && (
                    <>
                      <div className="my-8 p-6 bg-gray-50 dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-white/10">
                        <h2 className="text-2xl font-bold mb-4 !text-black dark:!text-white">
                          Team Leadership
                        </h2>
                        <p className="text-lg font-medium !text-black dark:!text-white">
                          Team Lead: {blog.content.team.lead}
                        </p>
                      </div>
                      ...
                      <div className="my-8 p-6 bg-gray-50 dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-white/10">
                        ...
                        <ul className="grid grid-cols-2 gap-3">
                          {blog.content.team.members.map((member, index) => (
                            <li key={index} className="flex items-center gap-2 !text-black dark:!text-white">
                      ...
                      <div className="my-8 space-y-4">
                        <div>
                          <h3 className="text-xl font-semibold !text-black dark:!text-white mb-2">
                            {blog.content.project.name}
                          </h3>
                          <p className="!text-black dark:!text-white">
                            {blog.content.project.description}
                          </p>
                        </div>
                        
                        {blog.content.project.technologies && (
                          <div>
                            <h4 className="text-lg font-semibold mb-2 !text-black dark:!text-white">Technologies Used:</h4>
                            <div className="flex flex-wrap gap-2">
                              {blog.content.project.technologies.map((tech, index) => (
                                <span 
                                  key={index}
                        ...
                        {(blog.content.project.link || blog.content.project.github) && (
                          <div className="flex gap-4 mt-4">
                            {blog.content.project.link && (
                              <a 
                                href={blog.content.project.link}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-all duration-700"
                              >
                                View Post
                              </a>
                            )}
                            {blog.content.project.github && (
                              <a 
                                href={blog.content.project.github}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-800 text-white rounded-lg transition-all duration-700"
                              >
                                View Code
                              </a>
                            )}
                  ...
                  <p className="text-lg leading-relaxed mb-6 !text-black dark:!text-white">
                  ...
                  {blog.content.hashtags && (
                    <div className="mt-8 pt-6 border-t border-gray-200 dark:border-white/10">
                      <div className="flex flex-wrap gap-2">
                        {blog.content.hashtags.map((hashtag, index) => (
                          <span 
                            key={index}
                ...
                <div className="flex gap-2 mb-4">
                  {[
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-14 h-14 rounded-lg flex items-center justify-center hover:bg-gray-300 dark:hover:bg-white/10 transition-all duration-700"
                    >
                ...
                >
                  ...
                  <div className="space-y-2">
                    {Object.entries(blogData)
                      .filter(([slug]) => slug !== (currentSlug || ('then' in params ? '' : params.slug)))
                      .map(([slug, post]) => ({
                        slug,
                        title: post.title,
                        date: post.date,
                      ...
                      <Link 
                        ...
                        className="flex gap-4 py-3 px-1 hover:bg-gray-200 dark:hover:bg-[#313131] transition-all duration-700 cursor-pointer"
                        style={{
                          width: '337.763px',
                          minHeight: '135px',
                          borderRadius: '0px'
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 flex flex-col justify-center">
                          <div className="flex items-center gap-1 mb-2">
                            ...
                            <span className="text-gray-400" style={{ fontSize: '14.4px' }}>{post.date}</span>
                          </div>
                          <h3 
                  ...
                  <div className="flex justify-center items-center gap-2 mt-6">
                    <button className="flex items-center justify-center w-10 h-10 rounded-lg bg-gray-100 dark:bg-[#1a1a1a] hover:bg-gray-200 dark:hover:bg-[#2a2a2a] transition-all duration-700">
                      <svg className="w-4 h-4 !text-black dark:!text-gray-400" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/>
                      </svg>
                    </button>
                    
                    <div className="flex gap-2">
                      <button className="w-10 h-10 rounded-lg bg-transparent border-2 border-blue-500 !text-black dark:!text-white font-medium flex items-center justify-center text-sm hover:bg-blue-500/10 transition-all duration-700">
                        1
                      </button>
                      <button className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-[#1a1a1a] !text-black dark:!text-gray-400 font-medium flex items-center justify-center hover:bg-gray-200 dark:hover:bg-[#2a2a2a] transition-all duration-700 text-sm">
                        2
                      </button>
                      <button className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-[#1a1a1a] !text-black dark:!text-gray-400 font-medium flex items-center justify-center hover:bg-gray-200 dark:hover:bg-[#2a2a2a] transition-all duration-700 text-sm">
                        3
        ...
        <div className="lg:hidden min-h-screen">
          ...
          <div className="px-4 space-y-4">
            ...
            <div className="rounded-none p-6 border-x-0 border-t border-b border-gray-300 dark:border-white/10 shadow-lg -mx-4 bg-white dark:bg-[#212121]">
              ...
              <h1 className="text-2xl font-bold mb-3 !text-black dark:!text-white leading-tight">
                {blog.title}
              </h1>
              ...
              <div className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400">
                ...
                <span>•</span>
                <span className="text-xs">By {blog.author}</span>
              </div>
            </div>
            ...
            <div className="rounded-none p-6 border-x-0 border-t border-b border-gray-300 dark:border-white/10 shadow-lg -mx-4 bg-white dark:bg-[#212121]">
              <div className="prose prose-sm dark:prose-invert max-w-none">
                <p className="text-base leading-relaxed mb-4 !text-black dark:!text-white">
                  {blog.content.introduction}
                </p>

                {blog.content.team && (
                  <>
                    <div className="my-6 p-4 bg-gray-50 dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-white/10">
                    ...
                    <div className="my-6 p-4 bg-gray-50 dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-white/10">
                      ...
                      <ul className="grid grid-cols-1 gap-2">
                        {blog.content.team.members.map((member, index) => (
                          <li key={index} className="flex items-center gap-2 !text-black dark:!text-white text-sm">
                            <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                            <span>{member}</span>
                          </li>
                        ))}
                ...
                {blog.content.project && (
                  <>
                    <div className="my-6 space-y-4">
                      ...
                      {blog.content.project.technologies && (
                        <div>
                          <h4 className="text-base font-semibold mb-2 !text-black dark:!text-white">Technologies Used:</h4>
                          <div className="flex flex-wrap gap-2">
                            {blog.content.project.technologies.map((tech, index) => (
                              <span 
                                key={index}
                        ...
                        <div className="flex flex-col gap-3 mt-4">
                          {blog.content.project.link && (
                            <a 
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors text-sm"
                            >
                              View Post
                            </a>
                          )}
                          {blog.content.project.github && (
                            <a 
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-800 text-white rounded-lg transition-colors text-sm"
                            >
                              View Code
                            </a>
                          )}
